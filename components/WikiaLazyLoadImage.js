...
class WikiaLazyLoadImage extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
      isLoading: false
  ...
  componentDidMount () {
    ...
    fetch(this.props.src) // <- src can be wikia/
      .then(res => res.json())
      .then(data => {
        this.setState({
